...
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='cat_sost.php'>Gestione cattedre</a> - $titolo", "", $_SESSION['nome_scuola'], $_SESSION['comune_scuola']);
