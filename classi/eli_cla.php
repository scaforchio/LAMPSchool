...
*/
	...
	//Esecuzione query
	$query="SELECT * FROM tbl_classi WHERE idclasse=". stringa_html('idcla');	
	...
	else
	{
		...
		if ($dati=mysqli_fetch_array($ris)) 
		{
			...
			print "<TR><TD ALIGN='CENTER'><FORM ACTION='del_cla.php' method='POST'>";
			print "<input type='hidden' name='idcl' value='". stringa_html('idcla'). "'>"; 
			print "<INPUT TYPE='SUBMIT' VALUE='SI'>";
			print "</FORM></TD>";
			
			print "<TD ALIGN='CENTER'><FORM ACTION='vis_cla.php' method='POST'>";
