...
$daticrud['campi'] = [
                      ...
                      ['rappresentante1',0,inspref('tbl_alunni'),'idalunno','cognome,nome',0,'Primo rappresentante',6,'','',0,'','',1,'cognalu1,nomealu1',0,inspref('select distinct(idalunno) from tbl_alunni where idclasse=') ],
                      ['rappresentante2',0,inspref('tbl_alunni'),'idalunno','cognome,nome',0,'Secondo rappresentante',7,'','',0,'','',0,'cognalu2,nomealu2',0,inspref('select distinct(idalunno) from tbl_alunni where idclasse=')]
                     ];
