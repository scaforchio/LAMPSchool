...
$verbale = converti_utf8("Verbale scrutinio $quadrimestre, classe $classe");
...
$schede->SetFont('Times', '', 12);
$schede->setXY(10, $posY);
$verbale = converti_utf8("Firma docenti presenti allo scrutinio del $quadrimestre, classe $classe");
$schede->MultiCell(190, 8, $verbale, NULL, "C");
$posY += 10;
...
//$schede->FooterAll();
//
$nomefile = "Verbale_" . $periodo . "_" . $idclasse . ".pdf";
