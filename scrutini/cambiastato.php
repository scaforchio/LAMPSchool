...
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='sitscrutini.php'>SITUAZIONE SCRUTINI</a> - $titolo", "", $_SESSION['nome_scuola'], $_SESSION['comune_scuola']);
