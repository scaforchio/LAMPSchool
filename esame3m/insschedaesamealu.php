...
$votom1 = stringa_html('votom1') != '' ? stringa_html('votom1') : '0';
$votom2 = stringa_html('votom2') != '' ? stringa_html('votom2') : '0';
$votom3 = stringa_html('votom3') != '' ? stringa_html('votom3') : '0';
$votom4 = stringa_html('votom4') != '' ? stringa_html('votom4') : '0';
$votom5 = stringa_html('votom5') != '' ? stringa_html('votom5') : '0';
$votom6 = stringa_html('votom6') != '' ? stringa_html('votom6') : '0';
...
$datacolloquio = stringa_html('datacolloquio');
...
$query = "update tbl_esesiti set
        ...
        scarto='$scarto',";
if ($datacolloquio != '')
    $query .= "datacolloquio='$datacolloquio',";
else
    $query .= "datacolloquio=NULL,";
$query .= "tracciacolloquio='$tracciacolloquio',
