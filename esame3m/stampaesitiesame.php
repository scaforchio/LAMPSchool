...
$schede->setXY(10, $posY);
$specplesso = converti_utf8("ESITI FINALI ESAME DI STATO A.S.:" . $_SESSION['annoscol'] . "/" . ($_SESSION['annoscol'] + 1) . " - " . decodifica_classe_spec($idclasse, $con) . " - Classe: " . decodifica_classe_no_spec($idclasse, $con, 1));
