...
$titolo = "Cambiamento password Esame di Stato";
...
print "<form name='form1' action='cambpassesameins.php' method='POST'>";
...
print '<center><br/><input type="submit" name="OK" id="OK" value="OK" disabled onclick="document.getElementById(\'password\').value=hex_md5(document.getElementById(\'passwor\').value);document.getElementById(\'npass\').value=hex_md5(document.getElementById(\'npas\').value);document.getElementById(\'rnpass\').value=hex_md5(document.getElementById(\'rnpas\').value)" >';
