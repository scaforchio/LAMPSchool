...
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_cla.php'>ELENCO CLASSI</a> - $titolo", "", $_SESSION['nome_scuola'], $_SESSION['comune_scuola']);
    ...
    if (($ques = eseguiQuery($con, $quella)))
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                print "
                 <form method='post' id='formdoc' action='../classi/vis_cla.php'>
