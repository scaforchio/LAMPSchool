...
*/
    ...
    stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_gru'>ELENCO GRUPPI</a> - $titolo","","$nome_scuola","$comune_scuola");
    ...
    $ris=mysqli_query($con,inspref($eli)) or die("Errore: ".inspref($eli));
