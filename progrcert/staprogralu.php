...
$titolo="Programmazione personalizzata alunno";
$script= "
...
print ('<body class="stampa" onLoad="printPage()">');
	...
	print "<center><img src='../abc/".$suff."testata.jpg' width=800 heigth=></center>";  
    ...
    $query="select * from tbl_competalu where idmateria=$idmateria and idclasse=$idclasse order by numeroordine";
    $ris=mysqli_query($con,inspref($query)) or die ("Errore nella query: ". mysqli_error($con));
   ...
   print "<br/><br/>(Le voci in <i>corsivo</i> fanno parte degli obiettivi minimi)<br>";
