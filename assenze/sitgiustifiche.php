...
$query = "SELECT count(*) as nrng,cognome, nome,tbl_alunni.idalunno,dataammonizione FROM tbl_ritardi,tbl_alunni,tbl_classi WHERE (isnull(giustifica) or giustifica=0) AND data< '$datalimiteinferiore'
