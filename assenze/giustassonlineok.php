...
if ($pass) {
    ...
    print "<br>Codice di verifica (6 cifre, inviata tramite SMS o generata da OTP) <br><br>
    <input class='form-control' style='width: 100px;' type='text' size='6' maxlength='6' name='token' id='token' Onkeyup='verifica();'>";
    print "<br><br><input type='submit' class='btn btn-sm btn-outline-secondary' id='subnp' value='Conferma giustifica' disabled>";
    print "</center></div>";
}else {
