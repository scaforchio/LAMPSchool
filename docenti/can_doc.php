...
else
{
    ...
    $result2 = eseguiQuery($con, $sql2);
    $Data2 = mysqli_fetch_array($result2);

    print("<CENTER>");

    print("<FORM NAME='CA2' ACTION='ca2_doc.php' method='POST'>");
    print("\n<table>\n");
    ...
    print("<tr><td></td></tr><td></td><tr><td></td></tr><tr></tr><tr><td colspan='2'> <center>Sei sicuro di voler eliminare il docente ?</center></td></tr>");
}
...
print("<FORM NAME='CAN' ACTION='vis_doc.php' method='POST'>");
