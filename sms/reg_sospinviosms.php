...
$titolo = "Registrazione nuova sospensione invio sms";
$script = "";
stampa_head($titolo, "", $script, "MSA");
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_sospinviosms.php'>ELENCO CLASSI</a> - $titolo", "", $_SESSION['nome_scuola'], $_SESSION['comune_scuola']);
...
} else
{
    ...
    print "
                 <form method='post' id='formdoc' action='./vis_sospinviosms.php'>
