...
/* programma per la modifica di un amministrativo
...
else
{
    ...
    print("<CENTER>");
    print("<FORM NAME='mod' action='mod_imp_s.php' method='post'>");
    print("\n<table>\n");

    print(" <tr><td><input type ='hidden' size='20' name='codice' value= '" . $Data['idamministrativo'] . "'></td>\n</tr>\n");
