...
/*programma per la modifica dei tbl_amministrativi
...
// istruzioni per tornare alla pagina di login 
	...
	$titolo="Modifica amministrativo";
    $script=""; 
   ...
   $s="UPDATE tbl_amministrativi SET cognome='$cognome',nome='$nome',datanascita='$aa-$mm-$gg',idcomnasc='$comnasc',indirizzo='$indirizzo',idcomres='$comresi',telefono='$telefono',telcel='$cellulare',email='$email' WHERE idamministrativo=$idamministrativo";
	...
	*/
	if($err==1) 
	{
	   ...
	   print("$mes");
	   print("<FORM NAME='hid' action='mod_imp.php' method='POST'>");
	...
	else
	{
        ...
        if ($res=mysqli_query($con,inspref($s)))
	        ...
	        print "ERRORE NELLA MODIFICA DEI DATI DEL amministrativo!";
