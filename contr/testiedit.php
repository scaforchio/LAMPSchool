...
else
{
    ...
    print "<TR class='prima'><TD ALIGN='CENTER'><B>Nome testo</B></TD><TD ALIGN='CENTER'><B>Valore</B></TD><TD ALIGN='CENTER'><B>Spiegazione</B></TD><TD COLSPAN='2' ALIGN='CENTER'><B>Azioni</B></TD></TR>";
    while ($dati = mysqli_fetch_array($ris))
    {
        print "<TR class='oddeven'><TD>" . $dati['nometesto'] . "</TD><TD>" . $dati['valore'] . "</TD><TD>" . $dati['spiegazione'] . "</TD><TD><A HREF='mod_testo.php?idpar=" . $dati['idtesto'] . "'><img src='../immagini/edit.png'></A></TD>";
