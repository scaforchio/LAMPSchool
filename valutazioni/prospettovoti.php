...
print ('
         <form method="post" action="prospettovoti.php" name="voti">
...
//    
    ...
    echo '<p align="center">
        <font size=4 color="black">Prospetto dei voti per la classe <i>' . $classe . '</i></font>';
...
// Fine codice per ricerca voti gi� inseriti
    ...
    echo '
       ...
       <p align="center"><small><small>La media SOP &egrave; data dalla media tra le valutazioni medie di scritto, orale e pratico. La media TOT &egrave; data dal totale di tutti i voti diviso il numero dei voti.</small></p>
