...
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='selealunnipresenza.php'>Presenze forzate</a> - $titolo", "", $_SESSION['nome_scuola'], $_SESSION['comune_scuola']);
