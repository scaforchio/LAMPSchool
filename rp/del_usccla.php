...
$titolo = "Conferma eliminazione uscita anticipata classe";
$script = "";
stampa_head($titolo, "", $script, "MSP");
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_usccla.php'>ELENCO USCITE POSTICIPATE CLASSI</a> - $titolo", "", $_SESSION['nome_scuola'], $_SESSION['comune_scuola']);
...
// Lettura dati uscita anticipata.
$querylett="select idannotazione from tbl_usciteclassi where iduscitaclasse=".stringa_html('idusccla');
...
//Esecuzione query cancellazione uscita anticipata
$eli = "delete from tbl_usciteclassi where iduscitaclasse=" . stringa_html('idusccla');
