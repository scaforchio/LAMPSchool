...
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_usccla.php'>ELENCO CLASSI</a> - $titolo", "", "$nome_scuola", "$comune_scuola");
...
} else
{
    ...
    print "
                 <form method='post' id='formdoc' action='../classi/vis_usccla.php'>
