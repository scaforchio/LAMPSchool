...
$titolo = "Inserimento nuova uscita classe";
$script = "<SCRIPT>
jQuery(function($){
...
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_usccla.php'>ELENCO ENTRATE POSTICIPATE CLASSI</a> - $titolo", "", $_SESSION['nome_scuola'], $_SESSION['comune_scuola']);
...
//Esecuzione query
print "<form name='form1' action='reg_usccla.php' method='POST'>";
...
print "<tr><td   ALIGN='CENTER'> Ora uscita </td>";
...
print "<input type='submit' name='registra' value='Registra uscita e annotazione'> </CENTER>";
