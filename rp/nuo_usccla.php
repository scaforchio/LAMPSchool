...
stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_usccla.php'>ELENCO ENTRATE POSTICIPATE CLASSI</a> - $titolo", "", "$nome_scuola", "$comune_scuola");
