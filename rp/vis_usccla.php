...
$titolo = "Elenco uscite anticipate delle classi";
$script = "";
...
//Esecuzione query
$query = "SELECT * FROM tbl_usciteclassi,tbl_classi
            WHERE tbl_usciteclassi.idclasse=tbl_classi.idclasse
...
{
    print "<br/><CENTER><form name='form2' action='nuo_usccla.php' method='POST'>";
    print "<input type='submit' name='nuouscpost' value='Nuova uscita anticipata'>";
    ...
    while ($dati = mysqli_fetch_array($ris))
    {
        ...
        print "<TD>"; // <A HREF='mod_usccla.php?idritcla=". $dati['identrataclasse']. "'><img src='../immagini/edit.png' title='Modifica'></A>";

        print "<A HREF='eli_usccla.php?idusccla=" . $dati['iduscitaclasse'] . "'><img src='../immagini/delete.png' title='Elimina'></A>";
