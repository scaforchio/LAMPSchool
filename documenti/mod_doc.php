...
*/
   ...
   $idalunno=stringa_html('idalunno'); 
	...
	else 
	{
       ...
       print "<form action='agg_doc.php' method='POST'>"; 
	    ...
	    if ($tipo=='pei')
	    {   
	        print "<tr><td ALIGN='CENTER'> Inclusione nel PEI </td> <td ALIGN='CENTER'> 
	                 <input type='checkbox' name='pei' value='yes'";
	        if ($dati['pei'])
	           print " checked";
	        print "></td></tr>"; 
	    }
	    else
	       print "<input type='hidden' name='pei' value='no'>";
