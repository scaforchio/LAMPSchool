...
*/
    ...
    $titolo="Cancellazione tipo documento";
    $script=""; 
    stampa_head($titolo,"",$script,"SDMAP");
    stampa_testata("<a href='../login/ele_ges.php'>PAGINA PRINCIPALE</a> - <a href='vis_tdoc.php'>Elenco</a> - $titolo","","$nome_scuola","$comune_scuola");
    ...
    $query="SELECT * FROM tbl_tipidocumenti WHERE idtipodocumento=$idsp";
    ...
    else
    {
        ...
        if ($dati=mysqli_fetch_array($ris)) 
        {
            ...
            print "<TD ALIGN='CENTER'>Tipo documento:</TD><TD ALIGN='CENTER'>".$dati['descrizione']."</TD></TR>";
            print "<TR><TD ALIGN='CENTER'><FORM ACTION='del_tdoc.php' method='POST'>";
            print "<input type='hidden' name='idspe' value='$idsp'>";
            print "<INPUT TYPE='SUBMIT' VALUE='SI'>";
            print "</FORM></TD>";
            
            print "<TD ALIGN='CENTER'><FORM ACTION='vis_tdoc.php' method='POST'>";
