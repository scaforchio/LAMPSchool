...
$titolo="Stampa PEI alunni certificati";
$script=""; 
...
print "<form action='sele_stampa_pei.php' method='post' name='alu' id='alu'>";
...
if ($idalunno!="")
{
		...
		print "<form action ='stampa_pei.php' method='post' target='_blank'>";
		print "<input type='hidden' name='idalunno' value='$idalunno'>";
		print "<br><center><input type='submit' value='Stampa PEI'></center>";
		print "</form>";
