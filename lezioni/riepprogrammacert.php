...
print ("<font size=2><center><br/>A.S. <i>$annoscolastico</i> <b><br/>Argomenti svolti</b><br/>Alunno <i>$alunno</i> - Materia: <i>$nomemateria</i>");
    
             
print("<br/>Docente: <i>$nominativo</i></center> ");
...
//
    ...
    if ($idalunno!="")
    {
      ...
      $query="select distinct argomenti from tbl_lezionicert where idalunno=$idalunno and idmateria=$idmateria and argomenti <> '' order by datalezione";
