...
riceve in ingresso iddocente*/
   ...
   $tipoutente=$_SESSION["tipoutente"]; //prende la variabile presente nella sessione
	...
	else
	{
		...
		print("<center><font color='red'><br><br><b>Attenzione! La cancellazione della lezione eliminerà argomenti e attività inserite!</b></font><br><br>");
	   print("<FORM NAME='CAN' ACTION='vis_lez_cert.php' method='POST'>");
	   print("<input type='hidden' name='iddocente' value='$b'>");
	   print("<INPUT TYPE='SUBMIT' VALUE='    Annulla    '><br>");
	   print("</FORM><br/>");
	   print("<FORM NAME='CA2' ACTION='ca2_lez_cert.php' method='POST'>");
