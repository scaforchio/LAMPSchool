...
$inilez=substr($periodo,0,1);
$finlez=substr($periodo,2,1); // OCCHIO stringa_html trasforma periodo da 1->2 a 1-&gt;2
...
else if (giorno_settimana($datadb)=="Dom")  
...
print "
<form method='post' action='vis_lez_cert.php'>
