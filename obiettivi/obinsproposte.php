...
$querydel = "delete from tbl_valutazioniobiettivi where idalunno=$idalunno and idobiettivo in (select idobiettivo from tbl_obiettivi where idclasse=$idclasse and idmateria=$idmateria)";
