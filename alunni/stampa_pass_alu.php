...
function stampa_pass_alunno($arridalu, $arrutalu, $arrpwalu)
{
    ...
    foreach ($arridalu as $idalu)
    {
        ...
        $int = estrai_testo("passalu00", $con);
        ...
        //  
        //  $posY+=30;
        $comunicazione = estrai_testo("passalu01", $con);
        $schede->MultiCell(190, 5, converti_utf8($comunicazione));
        ...
        $schede->SetXY(10, $posY);
        $schede->SetFont('Times', '', 12);
        $comunicazione = estrai_testo("passalu02", $con);
        $schede->write(6, converti_utf8($comunicazione));
        $posY = $schede->GetY();
        $posY += 10;
        $schede->SetXY(10, $posY);
        ...
        if ((estrai_testo("ricevutapassalu", $con) == 'yes') && ($posY < 230))
        {
            ...
            $schede->MultiCell(190, 5, converti_utf8(estrai_testo("passalu04", $con) . " $alunno " . estrai_testo("passalu05", $con)));
            $posY += 15;
            $schede->SetXY(10, $posY);
            $schede->SetFont('Times', '', 9);
