...
<center>
    ...
    <form enctype='multipart/form-data' method='post' action='carica_alunni_da_csv_ins.php'>
...
print("    <tr>
                <td><br>Sovrascrivere alunni già presenti?</td>
                <td><br>");
...
print("<tr><td><b>Data nascita</b></td><td><select name='posdata'>");
for ($i = 1; $i <= 30; $i++)
    if ($i == $arrpar[5])
    {
        print "<option selected>$i</option>";
...
print("<tr><td>Sesso</td><td><select name='possesso'>");
for ($i = 1; $i <= 30; $i++)
    if ($i == $arrpar[6])
    {
        print "<option selected>$i</option>";
...
print ("</select></td><td>&nbsp;</td></tr>");
print("<tr><td><b>Cod. fisc.</b></td><td><select name='poscodf'>");
for ($i = 1; $i <= 30; $i++)
    if ($i == $arrpar[7])
    {
        print "<option selected>$i</option>";
...
print("<tr><td>Cod. SIDI</td><td><select name='poscodsidi'>");
for ($i = 1; $i <= 30; $i++)
    if ($i == $arrpar[8])
    {
        print "<option selected>$i</option>";
...
print ("</select></td><td>Codice meccanografico SIDI</td></tr>");
