...
$daticrud['titolo'] = 'GESTIONE SOSPENSIONI COLLOQUI';


$daticrud['tabella'] = ("tbl_sospensionicolloqui");

$daticrud['larghezzatabella'] = "80%";
// Nome della tabella per visualizzazioni
$daticrud['aliastabella'] = "sospensionicolloqui";
// Campo con l'id univoco per la tabella
$daticrud['campochiave'] = "idsospensionecolloqui";
...
$daticrud['campiordinamento'] = "data, datafine";
...
$daticrud['campi'] = [
    ['0'=>'data','1'=>'1','6'=>'Data inizio periodo sospensione','7'=>1,'8'=>'date','10'=>1],
    ['0'=>'datafine','1'=> '2','6'=> 'Data fine periodo sospensione','7'=> 2,'8'=> 'date','10'=>1],
    ['0'=>'note', '1'=>'3', '5'=>30, '6'=>'Motivo','7'=> 3, '8'=>'text'],
