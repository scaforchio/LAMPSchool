...
*/
    ...
    $titolo="Aggiornamento ordinamento materia";
    $script=""; 
    ...
    $progrpag= stringa_html('progrpag');
    $media = stringa_html('media');
    ...
    else
    {
       ...
       print "
                 <form method='post' id='formdoc' action='../materie/ordmaterie.php'>
